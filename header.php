...
<body>
    <header class="header">
        <div class="header__left-block">
            <div class="header__logo">
                <img src="<?=SITE_TEMPLATE_PATH?>/icons/logo.svg" alt="Логотип">
            </div>
    ...
    <div class="sidepanel">
        ...
        <a href="#" class="sidepanel__icon">
            <img src="<?=SITE_TEMPLATE_PATH?>/icons/instagram.svg" alt="instagram">
        </a>
        <a href="#" class="sidepanel__icon">
            <img src="<?=SITE_TEMPLATE_PATH?>/icons/facebook.svg" alt="facebook">
        </a>
    </div>
        ...
        <div class="container">
            <div class="tabcontainer">
                <div class="tabcontent">
                    <img src="<?=SITE_TEMPLATE_PATH?>/img/tabs/vegy.jpg" alt="vegy">
                    <div class="tabcontent__descr">
                        Меню "Фитнес" - это новый подход к приготовлению блюд: больше свежих овощей и фруктов. Для людей, которые интересуются спортом; активных и здоровых. Это абсолютно новый продукт с оптимальной ценой и высоким качеством!
                    </div>
                </div>
                <div class="tabcontent">
                    <img src="<?=SITE_TEMPLATE_PATH?>/img/tabs/elite.jpg" alt="elite">
                    <div class="tabcontent__descr">
                        Меню “Премиум” - мы используем не только красивый дизайн упаковки, но и качественное исполнение блюд. Красная рыба, морепродукты, фрукты - ресторанное меню без похода в ресторан!                                     
                    </div>
                </div> 
                 <div class="tabcontent">
                    <img src="<?=SITE_TEMPLATE_PATH?>/img/tabs/post.jpg" alt="post">
                    <div class="tabcontent__descr">
            ...
            <div class="offer__slider">
                <div class="offer__slider-counter">
                    <div class="offer__slider-prev">
                        <img src="<?=SITE_TEMPLATE_PATH?>/icons/left.svg" alt="prev">
                    </div>
                    <span id="current">03</span>
                    /
                    <span id="total">04</span>
                    <div class="offer__slider-next">
                        <img src="<?=SITE_TEMPLATE_PATH?>/icons/right.svg" alt="next">
                    </div>
                </div>
                <div class="offer__slider-wrapper">
           <div class="offer__slider-inner">
                        <div class="offer__slide">
                            <img src="<?=SITE_TEMPLATE_PATH?>/img/slider/pepper.jpg" alt="pepper">
                        </div>
                        <div class="offer__slide">
                            <img src="<?=SITE_TEMPLATE_PATH?>/img/slider/food-12.jpg" alt="food">
                        </div>
                        <div class="offer__slide">
                            <img src="<?=SITE_TEMPLATE_PATH?>/img/slider/olive-oil.jpg" alt="oil">
                        </div>
                        <div class="offer__slide">
                            <img src="<?=SITE_TEMPLATE_PATH?>/img/slider/paprika.jpg" alt="paprika">
                        </div>
           </div>
                </div>
            </div>
    ...
    <div class="order">
        <div class="container">
            ...
            <form action="#" class="order__form">
                ...
                <img src="<?=SITE_TEMPLATE_PATH?>/icons/right.svg" alt="right">
